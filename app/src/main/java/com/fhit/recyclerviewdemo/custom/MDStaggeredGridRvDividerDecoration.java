...
/**
 * 表格分割线<br/>
 * Created by liubaoxing on 2018/3/7 16:24<br/>
 * Email:liubaoxinggo@foxmail.com<br/>
 *
 */

public class MDStaggeredGridRvDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public MDStaggeredGridRvDividerDecoration(Context context) {
        // 获取默认主题的属性
